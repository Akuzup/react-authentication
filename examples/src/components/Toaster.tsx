...
const ToastItem: React.FC<{ toast: Toast; onRemove: (id: string) => void }> = ({ 
  ...
  return (
    <div className={`max-w-sm w-full border rounded-lg shadow-lg p-4 ${typeStyles[toast.type]}`}>
      <div className="flex">
        <div className="flex-shrink-0">
          {toast.type === 'success' && (
            <svg className={`h-5 w-5 ${iconStyles[toast.type]}`} fill="currentColor" viewBox="0 0 20 20">
