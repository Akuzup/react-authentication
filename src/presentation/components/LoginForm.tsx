...
export const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    <div className={`auth-login-form ${className}`}>
      ...
      {showGoogleLogin && (
        <div className="mt-4">
          ...
          <button
            ...
            disabled={isFormDisabled}
            className={`mt-3 w-full flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium ${
              isFormDisabled
